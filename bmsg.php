...
<?php
  ...
  $sql="select * from messages where receiver_utype = 'branch' ";
  ...
  $result = mysqli_query($conn, $sql)or die(mysqli_error($conn));
    ...
    while($row = mysqli_fetch_assoc($result)) {
			...
			if (isset($result)){
                ...
                $temp["receiver_utype"] = $row["receiver_utype"];
            ...
            From: <?php echo $temp["sender_utype"]; ?> Office
            Receiver: <?php echo $temp["receiver"]; ?> 
            To: <?php echo $temp["receiver_utype"]; ?> Office
...
echo "<br/>";
?>
<button class="button" onclick="goBack()">Go Back</button></br></br>
