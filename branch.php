...
<ul>
  <li><a class="active" href="branch.php">Home</a></li>
  <div class="dropdown">
...
<form action="btransup.php" method="post"><pre>
<h3>Please enter your transaction data for today!</h3>
<input placeholder="Branch Office Name" type="text" name="bofficename" value="">
