...
if(strlen($_REQUEST["transsearch"])==0){
  ...
  $sql1="select * from dptransactions where date(date)='".$_REQUEST["transsearch"]."'";
  ...
  $result1 = mysqli_query($conn, $sql1)or die(mysqli_error($conn));
    ...
    (($row = mysqli_fetch_assoc($result)) || ($row1 = mysqli_fetch_assoc($result1)))) {
			...
			if (isset($result) && isset($result1)){
                ...
                $temp["dpofficename"] = $row1["dpofficename"];
                $temp["dptotaltransactions"] = $row1["totaltransactions"];
                $temp["dptotalamount"] = $row1["totalamount"];
            ?>
            ...
            <br><br>
            <table border="1px">
            <tr><th>DPGM Office Name</th><th>Total Transactions</th><th>Total Amount</th></tr>
...
<br/><button class="button"><a href="head.php">Go Back</a></button><br/>
